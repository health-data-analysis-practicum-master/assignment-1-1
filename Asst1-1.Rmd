...
**Due Sunday, February 2 @ midnight through Github**

Create a data diplay with the NMES data to answer:
...
4. When you are ready to submit your assignment, do ALL of the following:
...
* In the window that opens, **stage** your changes by clicking the check boxes next to the `Asst1-1.Rmd` and `Asst1-1.html` files.
