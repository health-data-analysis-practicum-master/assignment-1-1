...
**Due Sunday, January 27, 2025 \@ midnight through GitHub and on Piazza**
...
4.  When you have a final data display read to go, take a screenshot or download your display and post on Piazza under the Assignment 1-1 Display thread. You are welcome to post your screenshot anonymously to your classmates. If there are things that you wish you knew how to include in your display, but that we haven't learned about yet or you're unsure of how to implement, please include this in your Piazza post so we can be sure to cover that next week in class.

5.  When you are ready to submit your assignment, do ALL of the following:

-   First, knit your .Rmd file to see if it will compile. If it doesn't knit, you can still follow the steps below to submit your assignment, but please try to resolve the knitting issues before you submit. You can reach out to use at [phbiostats\@jhu.edu](mailto:phbiostats@jhu.edu){.email} for help!
